...
internal class NotificationTemplateMapperTest {
    ...
    @CsvSource(
        value = [
            ...
            "ENGLISH,PHOTO_RESUBMISSION, RESUBMISSION-ID-ENGLISH",
            ...
            "WELSH,PHOTO_RESUBMISSION, RESUBMISSION-ID-WELSH"
        ]
    )
    ...
    @CsvSource(
        value = [
            ...
            "ENGLISH,PHOTO_MINUS_RESUBMISSION, PHOTO_RESUBMISSION, RESUBMISSION-ID-ENGLISH",
            ...
            "WELSH,PHOTO_MINUS_RESUBMISSION, PHOTO_RESUBMISSION, RESUBMISSION-ID-WELSH",
        ]
    )
