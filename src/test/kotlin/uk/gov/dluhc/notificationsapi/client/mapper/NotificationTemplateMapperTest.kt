...
internal class NotificationTemplateMapperTest {
    ...
    @CsvSource(
        value = [
            ...
            ",PHOTO_MINUS_RESUBMISSION, PHOTO_RESUBMISSION, PHOTO-RESUBMISSION-ID-ENGLISH",
            ",ID_MINUS_DOCUMENT_MINUS_RESUBMISSION, ID_DOCUMENT_RESUBMISSION, DOCUMENT-RESUBMISSION-ID-ENGLISH",
            ...
            "ENGLISH,PHOTO_MINUS_RESUBMISSION, PHOTO_RESUBMISSION, PHOTO-RESUBMISSION-ID-ENGLISH",
            "WELSH,ID_MINUS_DOCUMENT_MINUS_RESUBMISSION, ID_DOCUMENT_RESUBMISSION, DOCUMENT-RESUBMISSION-ID-WELSH",
            ...
            "WELSH,PHOTO_MINUS_RESUBMISSION, PHOTO_RESUBMISSION, PHOTO-RESUBMISSION-ID-WELSH",
            "WELSH,ID_MINUS_DOCUMENT_MINUS_RESUBMISSION, ID_DOCUMENT_RESUBMISSION, DOCUMENT-RESUBMISSION-ID-WELSH",
        ]
    )
