...
internal class NotificationTemplateMapperTest {
    ...
    private val mapper = NotificationTemplateMapper(
        NotifyEmailTemplateConfiguration(
            ...
            overseas = OverseasNotifyEmailTemplateConfiguration(
                ...
                parentGuardianRequiredEnglish = "OVERSEAS-PARENT-GUARDIAN-REQUIRED-EMAIL-ENGLISH",
                parentGuardianRequiredWelsh = "OVERSEAS-PARENT-GUARDIAN-REQUIRED-EMAIL-WELSH",
                idDocumentRequiredEnglish = "OVERSEAS-ID-DOCUMENT-REQUIRED-EMAIL-ENGLISH",
                idDocumentRequiredWelsh = "OVERSEAS-ID-DOCUMENT-REQUIRED-EMAIL-WELSH",
                qualifyingAddressRequiredEnglish = "OVERSEAS-QUALIFYING-ADDRESS-REQUIRED-EMAIL-ENGLISH",
                qualifyingAddressRequiredWelsh = "OVERSEAS-QUALIFYING-ADDRESS-REQUIRED-EMAIL-WELSH",
        ...
        NotifyLetterTemplateConfiguration(
            ...
            overseas = OverseasNotifyLetterTemplateConfiguration(
                parentGuardianRequiredEnglish = "OVERSEAS-PARENT-GUARDIAN-REQUIRED-LETTER-ENGLISH",
                parentGuardianRequiredWelsh = "OVERSEAS-PARENT-GUARDIAN-REQUIRED-LETTER-WELSH",
                idDocumentRequiredEnglish = "OVERSEAS-ID-DOCUMENT-REQUIRED-LETTER-ENGLISH",
                idDocumentRequiredWelsh = "OVERSEAS-ID-DOCUMENT-REQUIRED-LETTER-WELSH",
                qualifyingAddressRequiredEnglish = "OVERSEAS-QUALIFYING-ADDRESS-REQUIRED-LETTER-ENGLISH",
                qualifyingAddressRequiredWelsh = "OVERSEAS-QUALIFYING-ADDRESS-REQUIRED-LETTER-WELSH",
    ...
    @CsvSource(
        value = [
            ...
            "OVERSEAS,,PARENT_GUARDIAN_REQUIRED,OVERSEAS-PARENT-GUARDIAN-REQUIRED-LETTER-ENGLISH",
            "OVERSEAS,,ID_DOCUMENT_REQUIRED,OVERSEAS-ID-DOCUMENT-REQUIRED-LETTER-ENGLISH",
            ...
            "OVERSEAS,ENGLISH,PARENT_GUARDIAN_REQUIRED,OVERSEAS-PARENT-GUARDIAN-REQUIRED-LETTER-ENGLISH",
            "OVERSEAS,ENGLISH,ID_DOCUMENT_REQUIRED, OVERSEAS-ID-DOCUMENT-REQUIRED-LETTER-ENGLISH",
            ...
            "OVERSEAS,WELSH,PARENT_GUARDIAN_REQUIRED,OVERSEAS-PARENT-GUARDIAN-REQUIRED-LETTER-WELSH",
            "OVERSEAS,WELSH,ID_DOCUMENT_REQUIRED, OVERSEAS-ID-DOCUMENT-REQUIRED-LETTER-WELSH",
    ...
    @CsvSource(
        value = [
            ...
            "OVERSEAS,,PARENT_GUARDIAN_REQUIRED,OVERSEAS-PARENT-GUARDIAN-REQUIRED-EMAIL-ENGLISH",
            ...
            "OVERSEAS,ENGLISH,PARENT_GUARDIAN_REQUIRED,OVERSEAS-PARENT-GUARDIAN-REQUIRED-EMAIL-ENGLISH",
            ...
            "OVERSEAS,WELSH,PARENT_GUARDIAN_REQUIRED,OVERSEAS-PARENT-GUARDIAN-REQUIRED-EMAIL-WELSH",
