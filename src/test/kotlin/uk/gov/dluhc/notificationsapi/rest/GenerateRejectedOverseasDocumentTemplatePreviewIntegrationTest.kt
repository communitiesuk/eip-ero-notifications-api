...
internal class GenerateRejectedOverseasDocumentTemplatePreviewIntegrationTest : IntegrationTest() {
    ...
    companion object {
        ...
        private const val REJECTED_QUALIFYING_ADDRESS_EMAIL_EN_TEMPLATE_ID = "b6406aa6-c762-49a6-912f-7e0437800cec"
        private const val REJECTED_QUALIFYING_ADDRESS_EMAIL_CY_TEMPLATE_ID = "10752429-44ee-429f-85bb-57ade4f62e5f"
        private const val REJECTED_QUALIFYING_ADDRESS_LETTER_EN_TEMPLATE_ID = "8975fe83-7e55-422c-b041-84607336b19e"
        private const val REJECTED_QUALIFYING_ADDRESS_LETTER_CY_TEMPLATE_ID = "23827953-f350-425b-b563-2a7e2835b469"
    ...
    @CsvSource(
        ...
        "$REJECTED_QUALIFYING_ADDRESS_EMAIL_EN_TEMPLATE_ID, QUALIFYING_MINUS_ADDRESS",
    ...
    @CsvSource(
        value = [
            ...
            "$REJECTED_QUALIFYING_ADDRESS_EMAIL_EN_TEMPLATE_ID, QUALIFYING_MINUS_ADDRESS, EMAIL, EN",
            "$REJECTED_QUALIFYING_ADDRESS_EMAIL_CY_TEMPLATE_ID, QUALIFYING_MINUS_ADDRESS, EMAIL, CY",
            "$REJECTED_QUALIFYING_ADDRESS_LETTER_EN_TEMPLATE_ID, QUALIFYING_MINUS_ADDRESS, LETTER, EN",
            "$REJECTED_QUALIFYING_ADDRESS_LETTER_CY_TEMPLATE_ID, QUALIFYING_MINUS_ADDRESS, LETTER, CY",
        ]
    )
