...
internal class SendNotificationServiceTest {
    ...
    @EnumSource(
        NotificationType::class,
        names = ["ID_DOCUMENT_RESUBMISSION", "ID_DOCUMENT_RESUBMISSION_WITH_REASONS", "ID_DOCUMENT_REQUIRED", "NINO_NOT_MATCHED", "BESPOKE_COMM", "NOT_REGISTERED_TO_VOTE", "SIGNATURE_RESUBMISSION", "SIGNATURE_RESUBMISSION_WITH_REASONS"],
    )
