...
internal class SendNotifyMessageMapperTest {
    ...
    fun `should map SQS SendNotifyMessage to SendNotificationRequestDto`() {
        ...
        val request = SendNotifyMessage(
            ...
            personalisation1 = listOf(TemplatePersonalisationNameValue(name = "applicant_name", value = "John")),
        )
        ...
        assertThat(notification.personalisation1).isEqualTo(expectedPersonalisation)
    ...
    fun `should map SQS SendNotifyPhotoResubmissionMessage to SendNotificationRequestDto`() {
        ...
        // When
        val notification = mapper.fromPhotoResubmissionToSendNotificationRequestDto(request)
