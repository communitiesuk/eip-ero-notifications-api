...
import uk.gov.dluhc.notificationsapi.messaging.stubs.TestSqsMessage
...
class SqsSenderConfiguration {
     ...
     * This happens in uk.gov.dluhc.notificationsapi.config.LocalStackContainerConfiguration.localStackContainerSettings()
     *
