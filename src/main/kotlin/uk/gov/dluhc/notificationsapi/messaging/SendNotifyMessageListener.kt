...
import uk.gov.dluhc.notificationsapi.client.GovNotifyApiGeneralException
...
class SendNotifyMessageListener(
    ...
    fun exceptionHandler(notifyRetryableError: GovNotifyApiGeneralException) {
        logger.info("Notify service failed with retryable error", notifyRetryableError)
    }
}
